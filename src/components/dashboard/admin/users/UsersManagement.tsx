// components/dashboard/admin/users/UsersManagement.tsx
'use client'
            ...
            <div className="mb-6 space-y-4">
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <select
                        ...
                        className="pl-4 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
