...
export default function VenuesManagement({ initialVenues }: Props) {
  ...
  return (
    <div className="sm:p-6 mt-20">
    <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Manage Venues</h1>
        <p className="text-gray-600 mt-1">View and manage all venues in the system</p>
    </div>
            ...
            <div className="relative w-full pt-[66.67%]"> {/* 2:3 aspect ratio */}
              ...
              <div className="absolute top-3 right-3 flex space-x-2">
                <button
                  ...
                  className="p-2 bg-white rounded-full shadow-lg hover:bg-gray-50 transition-colors duration-200 group"
                >
                ...
                >
                  {venue.status === 'active' ? (
                    ...
                    <EyeOff className="w-4 h-4 text-red-600 group-hover:text-red-700" />
                  )}
                </button>
                <button
                  onClick={() => {
              ...
              <div className="pt-4 border-t border-gray-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{venue.profiles?.email}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {venues.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">Get started by adding a new venue.</p>
        </div>
      )}
